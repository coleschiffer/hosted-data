...
const locationURL = 'https://dice.fm/venue/gold-diggers-n2mq';
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            const location = {
                ...
                '@id': locationURL,
                name: 'Gold—Diggers',
                url: 'https://gold-diggers.com/',
                description: '',
                geo: {
                    "@type": "GeoCoordinates",
                    latitude: 34.0905765, 
                    longitude: -118.3151395,
                },
                address: {
                    "@type": "PostalAddress",
                    streetAddress: "5632 Santa Monica Blvd",
...
async function scrapeData() {
   ...
   // console.log('Successfully fetched listings:', listings);
        ...
        fs.writeFileSync('gold.json', JSON.stringify(listings, null, 2));
