...
const locationURL = 'https://dice.fm/venue/healing-force-of-the-universe-8l92';
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            const location = {
                ...
                url: 'https://healingforcerecords.com/',
                description: 'A record store and event space in Pasadena, CA.',
                geo: {
                    "@type": "GeoCoordinates",
                    latitude: 34.1493959, // find correct
                    longitude: -118.1255718
                },
                address: {
                    "@type": "PostalAddress",
                    streetAddress: "1200 East Walnut Street",
...
async function scrapeData() {
   ...
   // console.log('Successfully fetched listings:', listings);
        ...
        fs.writeFileSync('healing.json', JSON.stringify(listings, null, 2));
